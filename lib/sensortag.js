...
SensorTag.prototype.readTemperature = function(callback) {
  this.connection.addNotificationListener(0x25, function(err, value) {
    if (err) {
      callback(err, null);
    }
...
SensorTag.prototype.readAccelerometer = function(callback) {
  this.connection.addNotificationListener(0x2D, function(err, value) {
    if (err) {
      callback(err, null);
    }
...
SensorTag.prototype.readHumidity = function(callback) {
  this.connection.addNotificationListener(0x38, function(err, value) {
    if (err) {
      callback(err, null);
    }
...
SensorTag.prototype.readMagnetometer = function(callback) {
  this.connection.addNotificationListener(0x40, function(err, value) {
    if (err) {
      callback(err, null);
    }
...
SensorTag.prototype.calibrateBarometer = function() {
  ...
  var self = this;
  this.connection.readHandle(0x52, function(err, value) {
    // Calibration factors
...
SensorTag.prototype.readBarometer = function(callback) {
  ...
  self.connection.addNotificationListener(0x4B, function(err, value) {
    if (err) {
      callback(err, null);
    }
...
SensorTag.prototype.calibrateGyroscope = function() {
  ...
  setTimeout(function() {
    self.connection.readHandle(0x57, function(err, value) {
...
SensorTag.prototype.readGyroscope = function(x, y, z, callback) {
  var self = this;
  this.connection.addNotificationListener(0x57, function(err, value) {
    var rawY = value.readInt16LE(0);
    var rawX = value.readInt16LE(2);
    var rawZ = value.readInt16LE(4);
...
SensorTag.prototype.checkPowerOnSelfTest = function(callback) {
  this.connection.readHandle(0x64, function(err, value) {
